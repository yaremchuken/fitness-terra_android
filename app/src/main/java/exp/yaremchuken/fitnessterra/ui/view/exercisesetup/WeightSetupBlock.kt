        ...
        Column(
            ...
            Row(
                ...
                Row(
                    Modifier
                        .weight(1F)
                        .clickable { adjust(50) }
                        .border(1.dp, Color.LightGray, RoundedCornerShape(topEnd = 12.dp))
                        .background(AppColor.LightestGray, RoundedCornerShape(topEnd = 12.dp)),
                    horizontalArrangement = Arrangement.Center
                ) {
                    Text(
                        text = "+50 ${stringResource(R.string.gr_title)}",
                        Modifier.padding(horizontal = 12.dp, vertical = 4.dp),
                        style = Typography.titleMedium,
                        textAlign = TextAlign.Center,
                        color = Color.DarkGray
            ...
            Row(
                ...
                Row(
                    Modifier
                        .weight(1F)
                        .clickable { if (weight > 1000) adjust(-1000) }
                ...
                Row(
                    Modifier
                        .weight(1F)
                        .clickable { if (weight > 100) adjust(-100) }
                        .border(1.dp, Color.LightGray)
                        .background(AppColor.LightestGray),
                    horizontalArrangement = Arrangement.Center
                ) {
                ...
                Row(
                    Modifier
                        .weight(1F)
                        .clickable { if (weight > 50) adjust(-50) }
                        .border(1.dp, Color.LightGray, RoundedCornerShape(bottomEnd = 12.dp))
                        .background(AppColor.LightestGray, RoundedCornerShape(bottomEnd = 12.dp)),
                    horizontalArrangement = Arrangement.Center
                ) {
                    Text(
                        text = "-50 ${stringResource(R.string.gr_title)}",
